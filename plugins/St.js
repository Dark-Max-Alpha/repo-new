...
Trex.addrex({ pattern: 'status', fromMe: true, desc: Lang.NOTES_USAGE }, async (message, match) => {
...
Trex.addrex({ pattern: 'down ?(.*)', fromMe: true, desc: Lang.SAVE_USAGE }, async (message, match) => {
...
Trex.addrex({ pattern: 'delstatus', fromMe: true, desc: Lang.DELETE_USAGE }, async (message, match) => {
