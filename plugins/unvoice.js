...
if (Config.WORKTYPE == 'private') {
    ...
    Trex.addrex({pattern: 'unvoice', fromMe: true,  deleteCommand: false,  desc: Lang.UV_DESC}, (async (message, match) => {    
    ...
    Trex.addrex({pattern: 'unvoice', fromMe: false, desc: Lang.UV_DESC}, (async (message, match) => {    
