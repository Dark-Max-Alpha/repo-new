...
Trex.addrex({pattern: 'welcome$', fromMe: true,  deleteCommand: false,  desc: Lang.WELCOME_DESC, dontAddCommandList: true}, (async (message, match) => {
...
Trex.addrex({pattern: 'welcome (.*)', fromMe: true,  deleteCommand: false,  dontAddCommandList: true}, (async (message, match) => {
    if (match[1] === '') {
...
Trex.addrex({pattern: 'goodbye$', fromMe: true,  deleteCommand: false,  desc: Lang.GOODBYE_DESC, dontAddCommandList: true}, (async (message, match) => {
...
Trex.addrex({pattern: 'goodbye (.*)', fromMe: true,  deleteCommand: false,  dontAddCommandList: true}, (async (message, match) => {
    if (match[1] === '') {
