...
if (hrs >= 19 && hrs <= 24) wish = '*ɢᴏᴏᴅ ɴɪɢʜᴛ 🌙*'
    ...
    const rows = [
        {title: '👿 ALL MENU 👿', description: `👿 T-REX PANEL 👿\n\n\n
 ╭────────────────
 │❰🍁🔱  T Rex BOT  🔱🍁❱
 ╰────────────────
 ╭────────────────
 ...
 ╰────────────────
  ...
  ❰🍁🔱  T Rex BOT  🔱🍁❱
       ...
       👿       Hiruwa        👿
` , rowId:"rowid1"},
        {title: '👿 ADVANCE MENU 👿', description:` 👿 ADVANCE MENU 👿 \n\n\n
╔═══════════════════════╗
...
╚══════════════════════
`, rowId:"rowid6"},
        {title: '👿 LOGO PACK 03 👿', description: "👿 COING SOON 👿", rowId:"rowid20"},
        {title: '👿 DOWNLOADER 👿', description:`
👿 ALL DOWNLOADER 👿\n\n\n
 ╭────────────────
 │  🍁👿 Downloader 👿🍁
...
`, rowId:"rowid10"},
        {title: '👿 Work Type PUBLIC 👿', description: ".public", rowId:"rowid9"},
        {title: '👿 Work Type PRIVATE 👿', description:".private", rowId:"rowid2"}
       ]
