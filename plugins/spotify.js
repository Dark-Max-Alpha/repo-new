...
if (Config.WORKTYPE == 'private') {
    ...
    Trex.addrex({ pattern: 'spotify ?(.*)', fromMe: true, desc: Lang.SPO_DESC,  deleteCommand: false}, async (message, match) => {
    ...
    Trex.addrex({ pattern: 'spotify ?(.*)', fromMe: false, desc: Lang.SPO_DESC}, async (message, match) => {
